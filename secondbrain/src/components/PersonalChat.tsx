...
¿En qué te gustaría que te ayude hoy?`,
  ...
  return (
    <>
      ...
      {!isMinimized && (
        <>
          <div className={`flex-1 overflow-y-auto p-3 md:p-4 space-y-4 min-h-0 ${styles.messagesContainer} ${styles.messagesArea}`}>
          ...
          {/* Error message */}
          {error && (
            <div className="px-3 md:px-4 py-2 bg-red-50 border-t border-red-200 flex-shrink-0">
